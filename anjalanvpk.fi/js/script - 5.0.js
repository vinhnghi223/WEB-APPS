...
(function ($, Drupal, window, document, undefined) {
    ...
    //---------------------------------------------DATA INITIALIZATION---------------------------------------------
        ...
        addDotsByVechileName(vechileName,perspective);

        /*showImgOnHover(vechileName,perspective,1);
        showImgOnHover(vechileName,perspective,2);
        showImgOnHover(vechileName,perspective,3);
        showImgOnHover(vechileName,perspective,4);
        showImgOnHover(vechileName,perspective,5); //what if we dont have a 5th position or more than 5 position?*/
        ...
        function showImgOnHover(vehicleName,perspective,order){
            ...
            $(targetId).hover(function() {
                console.log("when you hover, I appear ------------------------------------");
                ...
                $(this).click(function() {
                    ...
                    for(i=0;i<toggleIdArray.length;i++){
                        ...
                        if(i==(order-1)){ //notice: minus 1
                            $(toggleIdArray[i]).css('display','block');
